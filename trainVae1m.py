...
from dataloader.movieLoader import load_movielens_1m, preprocess_movielens
...
}, "check_point_1m/VAEmodel.pt")

print("Neural model saved to check_point_1m/VAEmodel.pt")
